  ...
  return (
    <div>
      ...
      <div className="mt-5 max-w-md">
        <SearchableSelect label={t.branch} value={branchId} onChange={changeBranch}>{branches.map((branch) => <option key={branch.id} value={branch.id}>{name(branch)}</option>)}</SearchableSelect>
      </div>
